...
from .types import MCPToolResult, ToolDefinition, ExecutionContext
...
class Tool:
    ...
    def to_definition(self) -> ToolDefinition:
        """Convert to ToolDefinition with JSON Schema inputSchema."""
        return ToolDefinition.from_parameters(
            name=self.name,
